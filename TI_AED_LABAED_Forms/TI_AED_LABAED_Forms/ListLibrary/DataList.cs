...
namespace ListLibrary
{
    ...
    /// </summary>
    public abstract class DataList : IComparable<DataList>, IEquatable<DataList> //Implementa o a interface IComparable para utilizar o Sort da lista, e método Equals() para comparar a igualdade valor
    {
        ...
        public abstract int CompareTo(DataList obj);
        /// <summary>
        ...
        public abstract bool Equals(DataList other);
