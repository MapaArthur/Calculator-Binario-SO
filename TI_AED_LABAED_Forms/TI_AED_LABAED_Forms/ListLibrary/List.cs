...
namespace ListLibrary
{
    ...
    public class List : IStructure
    {
        ...
        protected Element First { get { return this.first;} set { first = value; } }
        protected Element Last { get { return this.last; } set { last = value; } }
        ...
        public virtual void AddEnd(DataList Obj)
        {
            if (Obj != null)
            {
        ...
        /// </summary>
        /// <param name="Obj">Objeto Data.</param>
        public virtual void AddSorted(DataList Obj)
        {
            if (Obj != null)
            {
        ...
        /// </summary>
        /// <param name="Obj">Objeto Data.</param>
        public virtual void AddStart(DataList Obj)
        {
            if (Obj != null)
            {
                Element _new = new Element(Obj);
        ...
        public virtual DataList Find(DataList Obj)
        {
            Element aux = this.first.next; //auxiliar para percorrer a lista
            while (aux != null) //enquanto o aux não é o último da lista, percorre a lista.
            {
        ...
        public virtual DataList Remove(DataList Obj)
        {
            Element aux = this.first.next; //auxiliar para percorrer a lista
            while (aux != null) //enquanto o aux não é o último da lista, percorre a lista.
            {
        ...
        public virtual DataList RemoveStart()
        {
            if (!this.Empty())
            {
                Element aux = this.first.next; //auxiliar para percorrer a lista
        ...
        public virtual DataList RemoveEnd()
        {
            if (!this.Empty())
            {
        ...
        public void Sort()
        {
            ...
            {
                int qtd = Count;
                DataList[] auxVetor = new DataList[qtd];
                for (int i = 0; i < qtd; i++)
                {
